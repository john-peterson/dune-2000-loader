...
extern LPDIRECTDRAWSURFACE7 fakeSurface;

interface hkIDirectDrawSurface7 : public IDirectDrawSurface7
{
	hkIDirectDrawSurface7( )
	{
		m_pDDrawSurface7 = 0;
	}

	hkIDirectDrawSurface7( IDirectDrawSurface7 **lpInterface )
	{
		SetupHook( lpInterface );
	}

	void				SetupHook				( IDirectDrawSurface7 **lpInterface )
	{
		m_pDDrawSurface7 = *lpInterface;
		*lpInterface = this;
	}

	IDirectDrawSurface7			*m_pDDrawSurface7;
