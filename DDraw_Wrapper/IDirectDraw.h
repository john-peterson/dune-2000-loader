...
public:
	...
	hkIDirectDraw( IDirectDraw **lpInterface )
	{
		m_pDDraw = *lpInterface;
		*lpInterface = this;
	}
...
interface hkIDirectDraw7 : public IDirectDraw7
{
public:

	hkIDirectDraw7( IDirectDraw7 **lpInterface )
	{
		m_pDDraw7		= *lpInterface;
		*lpInterface	= this;
	}

	IDirectDraw7				*m_pDDraw7;
	LPDIRECTDRAWSURFACE			m_lpDDrawSurface;
