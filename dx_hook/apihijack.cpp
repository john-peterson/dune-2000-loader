...
bool HookAPICalls(SDLLHook **DLLHooks, const unsigned int cDLLHooks)
{
	...
	while(pImportDesc->FirstThunk)
	{
		...
		{
			// Check if the exe loaded a DLL we want to hook
